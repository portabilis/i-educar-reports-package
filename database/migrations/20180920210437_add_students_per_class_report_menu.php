...
class AddStudentsPerClassReportMenu extends AbstractMigration
{
    public function up()
    {
        $this->execute(
            '
                ...
                VALUES (999101, 55, 2, \'Relatório de alunos por turma\', \'module/Reports/StudentsPerClass\', null, 3);
                ...
                VALUES (999101, 999101, 999923, \'Relatório de alunos por turma\', 0, \'module/Reports/StudentsPerClass\', \'_self\', 1, 15, 155, 2);
                
                INSERT INTO pmieducar.menu_tipo_usuario (ref_cod_tipo_usuario, ref_cod_menu_submenu, cadastra, visualiza, exclui) 
                VALUES (1, 999101, 1, 0, 1);
