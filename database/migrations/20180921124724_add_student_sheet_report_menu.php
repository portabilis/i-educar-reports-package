...
class AddStudentSheetReportMenu extends AbstractMigration
{
    public function up()
    {
        $this->execute(
            '
                ...
                VALUES (999203, 55, 2, \'Ficha do aluno\', \'module/Reports/StudentSheet\', null, 3);
                ...
                VALUES (999203, 999203, 999861, \'Ficha do aluno\', 0, \'module/Reports/StudentSheet\', \'_self\', 1, 15, 190, 2);
                
                INSERT INTO pmieducar.menu_tipo_usuario (ref_cod_tipo_usuario, ref_cod_menu_submenu, cadastra, visualiza, exclui) 
                VALUES (1, 999203, 1, 0, 1);
